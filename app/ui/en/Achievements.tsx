import { counterEnglish } from "@/app/lib/achievement-data";
          ...
          {counterEnglish.map(({ icon, endNumber, label }, index) => (
            ...
            >
              ...
              >
                ...
                <div className="x-counter-after text-lg mt-2">{label}</div>
              </div>
              {index < counterEnglish.length - 1 && (
                <hr
